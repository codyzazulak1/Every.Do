...
- (void)insertNewObject:(id)sender {
    ...
    ToDoItem *object = [[ToDoItem alloc]initWithTitle:@"Title" andItemDescription:@"Description" andPriority:1 andIsComplete:NO];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.hidden = !object.isComplete;
    return cell;
}
